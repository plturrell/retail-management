...
Example:
  python3 scripts/pdf_material_reference_to_mangle.py \
    --input "docs/Adobe Scan 12 Apr 2026.pdf" \
    --output-json "ocr_outputs/material_reference_adobe_scan_12_apr_2026.json" \
    --output-mangle "mangle_facts/material_reference.mangle" \
    --pos-items "mangle_facts/pos_orders.mangle"
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-json",
        default="ocr_outputs/material_reference.json",
        help="Normalized JSON output",
    )
    parser.add_argument(
        "--output-mangle",
        default="mangle_facts/material_reference.mangle",
        help="Mangle facts output",
    )
    parser.add_argument(
        "--pos-items",
        default="mangle_facts/pos_orders.mangle",
    ...
    mangle_path = Path(args.output_mangle).resolve()
    pos_items_path = Path(args.pos_items).resolve()
