...
Outputs:
  - JSON extraction payload in ocr_outputs/
  - Mangle facts in mangle_facts/
...
DEFAULT_OUTPUT_JSON = "ocr_outputs/sales_taka_gcp_vertex.json"
DEFAULT_OUTPUT_MANGLE = "mangle_facts/sales_taka_sales.mangle"
DEFAULT_MATERIALS_JSON = "ocr_outputs/material_reference_adobe_scan_12_apr_2026.json"
DEFAULT_POS_ITEMS = "mangle_facts/pos_orders.mangle"
...
def main() -> None:
    ...
    materials_json = Path(args.materials_json).resolve()
    pos_items = Path(args.pos_items).resolve()
    output_json = Path(args.output_json).resolve()
    output_mangle = Path(args.output_mangle).resolve()
