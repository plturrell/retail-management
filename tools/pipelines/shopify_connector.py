...
from paths import MANGLE_FACTS_DIR, PRODUCT_IMAGES_DIR, SHOPIFY_AUTH_FILE

# ── Config ────────────────────────────────────────────────────────────────────
CATALOG_FILE = str(MANGLE_FACTS_DIR / "product_catalog.mangle")
POS_ORDERS_FILE = str(MANGLE_FACTS_DIR / "pos_orders.mangle")
IMAGES_DIR = str(PRODUCT_IMAGES_DIR)
SHOPIFY_SYNC_FILE = str(MANGLE_FACTS_DIR / "shopify_sync.mangle")
AUTH_CACHE_FILE = str(SHOPIFY_AUTH_FILE)
